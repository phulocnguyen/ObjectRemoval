...
from models.ObjectDetection.yolo_model import load_yolo_model
from models.SwinSegmentation.models.swin_segformer import load_swinsegformer_model
...
def process_image(image_path, output_path):
    ...
    predictor = load_swinsegformer_model()
